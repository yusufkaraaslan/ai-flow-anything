...
- `skeletons/*.md` — Flow templates with `{slot-name}` placeholders. Standard set is eight files: `design-flow.md`, `implement-flow.md`, `free-flow.md`, `parallel-implement-flow.md`, `pr-flow.md`, `test-flow.md`, `deploy-flow.md`, `docs-flow.md`.
